...
You still need to edit [`trading_bot/backend/.env`](trading_bot/backend/.env.example) with real provider keys before expecting the bot to behave like anything except a skeleton.
