...
const nextConfig: NextConfig = {
  ...
  async redirects(): Promise<Array<{ source: string; destination: string; permanent: boolean }>> {
    return [
      ...
      { source: "/discovery-lab/run-lab", destination: "/workbench/sandbox", permanent: false },
      ...
      { source: "/discovery-lab/results", destination: "/workbench/sandbox", permanent: false },
      { source: "/discovery-lab/strategy-ideas", destination: "/workbench/grader", permanent: false },
