...
const envSchema = z.object({
  ...
  LIVE_STRATEGY_PRESET_ID: z.enum(["FIRST_MINUTE_POSTGRAD_CONTINUATION", "LATE_CURVE_MIGRATION_SNIPE", "SCALP_30_60_FAST"]).default("FIRST_MINUTE_POSTGRAD_CONTINUATION"),
  DRY_RUN_STRATEGY_PRESET_ID: z.enum(["FIRST_MINUTE_POSTGRAD_CONTINUATION", "LATE_CURVE_MIGRATION_SNIPE", "SCALP_30_60_FAST"]).default("LATE_CURVE_MIGRATION_SNIPE"),
  ...
  ALLOW_UNVERIFIED_LIVE_DEPLOY: booleanEnv(false),
  DISCOVERY_LAB_DISABLE_CREATED_PACKS: booleanEnv(false),
  DISCOVERY_LAB_DISABLE_WORKSPACE_SEEDS: booleanEnv(false),
  DISCOVERY_LAB_PRUNE_STALE_CUSTOM_PACKS: booleanEnv(false),
});
