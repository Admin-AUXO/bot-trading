...
const envSchema = z.object({
  ...
  DISCOVERY_SOURCES: csvListSchema("all"),
  ...
  DISCOVERY_LOOKBACK_SECONDS: z.coerce.number().int().positive().default(180),
  ...
  RESEARCH_FULL_EVALUATION_LIMIT: z.coerce.number().int().positive().max(100).default(10),
  ...
  RESEARCH_BIRDEYE_UNIT_CAP: z.coerce.number().int().positive().default(1_000),
  RESEARCH_HELIUS_UNIT_CAP: z.coerce.number().int().positive().default(25),
  ...
  MIN_UNIQUE_BUYERS_5M: z.coerce.number().int().nonnegative().default(50),
  MIN_BUY_SELL_RATIO: z.coerce.number().nonnegative().default(1.7),
  ...
  MAX_GRADUATION_AGE_SECONDS: z.coerce.number().int().positive().default(180),
