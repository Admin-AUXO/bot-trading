...
const botSettingsSchema = z.object({
  ...
  strategy: z.object({
    ...
    liveStrategy: z.object({
      ...
      winnerCohorts: z.array(z.object({
      ...
      decisionBands: z.array(z.object({
        id: z.string().trim().min(1),
        cohortKey: z.string().trim().min(1),
        label: z.string().trim().min(1),
        eligibility: z.string().trim().min(1),
        entryPosture: z.string().trim().min(1),
        sizePosture: z.string().trim().min(1),
        exitPosture: z.string().trim().min(1),
