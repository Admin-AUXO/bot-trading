...
const CREATED_PACK_SEEDS: CreatedPackSeed[] = [
  ...
  },
  {
    ...
    defaultProfile: "scalp",
    thresholdOverrides: {
      minLiquidityUsd: 11_000,
      maxMarketCapUsd: 975_000,
      minHolders: 48,
      minVolume5mUsd: 2_300,
      minUniqueBuyers5m: 16,
      minBuySellRatio: 1.13,
      maxTop10HolderPercent: 39,
      maxSingleHolderPercent: 19,
      maxGraduationAgeSeconds: 1_800,
    ...
    recipes: [
      ...
      buildGraduatedRecipe({
        ...
        sortBy: "last_trade_unix_time",
        graduatedLookbackSeconds: 1_740,
