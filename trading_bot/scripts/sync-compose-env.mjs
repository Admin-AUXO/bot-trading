...
CONTROL_SECRET=${env.CONTROL_API_SECRET || ""}
API_URL=${env.API_URL || "http://127.0.0.1:3101"}
DASHBOARD_AUTH_USERNAME=${env.DASHBOARD_AUTH_USERNAME || "operator"}
DASHBOARD_AUTH_PASSWORD=${env.DASHBOARD_AUTH_PASSWORD || env.CONTROL_API_SECRET || ""}
